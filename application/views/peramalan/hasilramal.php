            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        ...
                        <a onclick="return confirm('Yakin ingin reset nilai alpha?')" href="<?= base_url('peramalan/reset'); ?>" class="btn btn-secondary">Reset</a>
                    </div>
    ...
    <div class="row justify-content-center">
        <div class="card shadow mb-4">
            ...
            <div class="card-header bg-danger py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-white">Grafik Ramalan Furniture </h6>
            </div>
            <!-- Card Body -->
            <div class="card-body">
                    ...
                    <table class="table table-striped w-100 dt-responsive nowrap" id="dataTable">
                        <thead>
                            <tr>
                                ...
                                <th>Aktual</th>
                                <th>Peramalan</th>
                                <th>Deviasi absolut<br>[Et = Xt-Ft ]</th>
                                <th>Kesalahan<br>[Et^2]</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped w-100 dt-responsive nowrap" id="dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>MSE = <?= $totalNilaiMse ?>/12</td>
                                </tr>
                                <tr>
                                    <td>= <?= round($totalNilaiMse / 12, 0); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
